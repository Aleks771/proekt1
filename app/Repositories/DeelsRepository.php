...
class DeelsRepository extends CoreRepository
{
    /**
...
//       var_dump($GLOBALS['access_token']); // Проверим есть-ли у нас токен доступа - выводим его на экран
        ...
        function get_records(){
            ...
            $token_url = 'https://www.zohoapis.com/crm/v2/Accounts'; //URL-адреса для запроса
...
//       var_dump($GLOBALS['access_token']); // Проверим есть-ли у нас токен доступа - выводим его на экран
        ...
        function insert_records(){
            ...
            $post_data = [
                'data' => [
                    [
                        "Deal_Name" => $dataform['deal_name'],
                        "Account_Name" => $dataform['account_name'],
                        "Closing_Date" => $dataform['closing_date'],
            ...
            $token_url = 'https://www.zohoapis.com/crm/v2/Deals';
